...
class GildedRoseTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testNormalItem(){
		$program = new Program(array(new Item(array('name' => 'Normal Item', 'sellIn' => 10, 'quality' => 20))));
	...
	public function testWhenSellInDateHasPassed_normalItemQualityDecreasesByTwo(){
		$program = new Program(array(new Item(array('name' => 'Normal Item', 'sellIn' => 0, 'quality' => 20))));
		$program->UpdateQuality();
		$items = $program->getItems();
