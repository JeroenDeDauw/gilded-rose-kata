...
class GildedRoseTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testWhenSellInIsNotZero_conjuredItemQualityDecreasesByTwo()
	{
		$item = new Item(array("name" => "Conjured Mana Cake", "sellIn" => 20, "quality" => 10));
		$this->assertItemQuality($item, 8);
	}

	public function testWhenSellInIsZero_conjuredItemQualityDecreasesByFour()
	{
		$item = new Item(array("name" => "Conjured Mana Cake", "sellIn" => 0, "quality" => 10));
		$this->assertItemQuality($item, 6);
	}
